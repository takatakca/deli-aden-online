...
export const MENU: MenuCategory[] = [
    ...
    items: [
      {
        ...
        price: 14.99,
        image: img("photo-1604908554049-29bce8a47b75"),
      },
      {
        id: "tajine-zitoun",
        name: "Tajine Zitoun",
  ...
  },
  {
    ...
    items: [
      ...
      { id: "poulet-roti", name: "Poulet Rôti au Four", description: "Poulet tendre et juteux, assaisonné d'herbes et d'épices, peau dorée et croustillante.", price: 18.99, image: img("photo-1598103442097-8b74394b95c6"), options: [garnitureGroup, sauceGroup] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "sandwich-vh", name: "Sandwich Viande Hachée", description: "Sandwich généreux de viande hachée épicée.", price: 11.99, image: img("photo-1606755962773-d324e0a13086"), combo: true },
      ...
      { id: "panini-vh", name: "Panini Viande Hachée", price: 10.99, image: img("photo-1539252554453-80ab65ce3586"), combo: true },
      { id: "panini-poulet", name: "Panini Poulet Mariné", price: 10.99, image: img("photo-1626700051175-d4c9b0a35e0b"), combo: true },
      { id: "panini-thon", name: "Panini Thon", price: 10.99, image: img("photo-1539252554453-80ab65ce3586"), combo: true },
      ...
      { id: "chicken-burger", name: "Chicken Burger", price: 11.99, image: img("photo-1606755962773-d324e0a13086"), combo: true },
  ...
  },
  {
    ...
    items: [
      { id: "sardine", name: "Plat Sardine", description: "Sardines grillées ou poêlées, relevées d'épices, servies avec salade fraîche, riz parfumé ou pommes de terre.", price: 15.99, image: img("photo-1535140728325-a4d3707eee94"), options: [garnitureGroup] },
  ...
  },
  {
    ...
    items: [
      { id: "mhadjeb", name: "Mhadjeb", description: "Délicieuses crêpes fines à base de semoule, farcies de légumes épicés.", price: 3.99, image: img("photo-1601050690597-df0568f70950") },
      ...
      { id: "brik", name: "Brik Annabi", description: "Feuilleté croustillant farci de viande ou de thon, parfumé aux épices et herbes traditionnelles.", price: 8.0, image: img("photo-1626700051175-d4c9b0a35e0b") },
      ...
      { id: "bourek", name: "Bourek", description: "Feuilletés croustillants garnis de viande, épices et herbes fraîches.", price: 3.0, image: img("photo-1626700051175-d4c9b0a35e0b") },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "milk-tea", name: "Milk Tea", price: 2.0, image: img("photo-1558857563-c0c6ee6ff8a7") },
  ...
  },
  {
    ...
    items: [
      { id: "loubia", name: "Soupe Loubia", description: "Soupe traditionnelle aux haricots blancs, tomate et épices.", price: 7.99, image: img("photo-1547592166-23ac45744acd") },
      { id: "lentilles", name: "Soupe Lentilles", description: "Soupe veloutée de lentilles, parfumée aux épices.", price: 7.99, image: img("photo-1606755962773-d324e0a13086") },
